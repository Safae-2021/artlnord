    ...
    <div class="card-body">
      ...
      <form action="{{route('store.part')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" id="label"  placeholder="Partie " name="label">
        ...
        <div class="col-lg-6">
          ...
          <div class="input-group mb-3">
            <input type="number" class="form-control" id="studentsnumber"  placeholder="Nombre dՎtudiants" name="studentsnumber">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-align-center"></span>
              </div>
