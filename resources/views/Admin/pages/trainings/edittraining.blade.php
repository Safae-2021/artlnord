...
<div class="container-fluid " >
  <div class="card card-outline card-primary col-9 mt-5 " style="margin-left: 20%">
    ...
    <div class="card-body">
      ...
      <form action="{{route('update.training',$selectTrainingInfo[0]->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row ">
          <div class="col-lg-12">
        <label for="label">{{__('Formation ')}}</label>
        <div class="input-group mb-3">
          <input type="text" class="form-control" id="label"  placeholder="Formation " name="label" value="{{$selectTrainingInfo[0]->label}}">
        ...
        {{-- <div class="col-lg-6">
          <label for="studenttotalnumber">{{__('Nombre Total d’étudiants ')}}</label>
          <div class="input-group mb-3">
            <input type="number" class="form-control" id="studenttotalnumber"  placeholder="Nombre Total d’étudiants" name="studenttotalnumber" value="{{$selectTrainingInfo[0]->studenttotalnumber}}">
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-align-center"></span>
              </div>
          ...
          <div class="text-danger">{{$errors->first('studenttotalnumber')}}</div>
          </div> --}}
      </div>
      ...
      <div class="row ">
        <div class="col-lg-6">
            ...
            <div class="input-group mb-3">
              <input type="date" class="form-control" id="startdate" name="startdate" placeholder="Date début" value="{{$selectTrainingInfo[0]->startdate}}">
              <div class="input-group-append">
                <div class="input-group-text">
          ...
          <div class="col-lg-6">
            ...
            <div class="input-group mb-3">
              <input type="date" class="form-control" id="enddate" name="enddate" placeholder="Date fin" value="{{$selectTrainingInfo[0]->enddate}}">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-calendar"></span>
                </div>
        ...
        <div class="row ">
            <div class="col-lg-6">
                ...
                <div class="input-group mb-3">
                  <input type="time" class="form-control" id="starttime" name="starttime" placeholder="heure début" value="{{$selectTrainingInfo[0]->starttime}}">
                  <div class="input-group-append">
                    <div class="input-group-text">
                      <span class="fas fa-calendar"></span>
                    </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="input-group mb-3">
                  <input type="time" class="form-control" id="endtime" name="endtime" placeholder="heure fin" value="{{$selectTrainingInfo[0]->endtime}}">
                  <div class="input-group-append">
                    <div class="input-group-text">
                      <span class="fas fa-calendar"></span>
                    </div>
            ...
            <div class="row ">
              <div class="col-lg-12">
                  ...
                  <div class="col-lg-12">
                      <div class="card-body">
                        <textarea id="summernote" name="description">
                          {{ $selectTrainingInfo[0]->description}}
                        </textarea>
                      </div>
                  </div>
                </div>
                ...
                {{-- <div class="col-lg-6">
                  ...
                  <div class="input-group mb-3">
                    <input type="number" class="form-control" id="order" name="order" placeholder="Ordre" value="{{$selectTrainingInfo[0]->order}}">
                    <div class="input-group-append">
                      <div class="input-group-text">
                        <span >12 </span>
                      </div>
            ...
            <div class="row">
              <div class="col-lg-4">
                ...
                <div class="dropdown">
                  <select class="btn btn-primary  custom-select"  name="part_id"   type="button" id="part_id" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" multiple>
                     partie
                    <option ></option>
                  @foreach ($selectPart as $part)
              ...
              <div class="col-lg-4">
                <label for="requested_document_id">{{__('Documents Denander')}}</label>
                <div class="dropdown">
...
<div class="row">
    ...
    <div class="col-3 mt-2 pb-3" style="margin-left: 24%">
      <a  href="{{route('training.list')}}" class="btn btn-primary btn-block">Annuler</a>
    </div>
    <!-- /.col -->
  </div>
