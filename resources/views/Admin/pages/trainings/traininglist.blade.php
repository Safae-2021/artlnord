...
<div class="card mt-5 ">
    ...
    <div class="mt-2">
      <h4 class="text-center">La liste des Archives <a href="{{route('trashed.training')}}">
      ...
      <table class="table table-sm table-striped " id="example1" >
       ...
       @forelse ($selectTraining as $training)
          <tr>
            ...
            <td><a href="{{route('formation',[$training->id,'#formation'])}}">Voir Section</a></td>
            ...
            <td> 
               ...
               <a href="{{route('training.list.two',$training->id)}}"> <i class="fas fa-arrow-right ml-3" style="color:green"></i> </a>
            </td>           
        </tr>
       @empty
