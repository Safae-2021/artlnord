...
<div class="container-fluid " >
  <div class="card card-outline card-primary col-9 mt-5 " style="margin-left: 20%">
    ...
    <div class="card-body">
      ...
      <form action="{{route('update.group',$selectGroupInfo[0]->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row ">
          <div class="col-lg-6">
        <label for="label">{{__('Group ')}}</label>
        <div class="input-group mb-3">
          <input type="text" class="form-control" id="label"  placeholder="Group" name="label" value="{{$selectGroupInfo[0]->label}}">
      ...
      <div class="row ">
        ...
        <div class="col-lg-6">
          <label for="teacher_id">{{__('Preosseur')}}</label>
          <div class="dropdown">
...
<div class="row">
    ...
    <div class="col-3 mt-2 pb-3" style="margin-left: 24%">
      <a  href="{{route('group.list')}}" class="btn btn-primary btn-block">Annuler</a>
    </div>
    <!-- /.col -->
  </div>
      </form>
