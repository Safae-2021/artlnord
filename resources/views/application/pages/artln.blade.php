@extends('layouts.application')
        ...
        @section('content') 
    <!-- About Start -->
    <div class="container-fluid py-5" id="artln">
        <div class="container">
    ...
    {{-- <div class="jumbotron jumbotron-fluid mb-5  image-organigrame  " > --}}
        
       
        <!-- <h6 class="text-primary text-uppercase font-weight-bold">A Propos</h6> -->
         <img src="{{asset('img/organigrame.jpg')}}" alt="" class="img-fluid w-100">
        {{-- </div> --}}
